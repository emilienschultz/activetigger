...
class BertModels():
    ...
    def start_training_process(self,
        ...
        # Update the queue
        b = BertModel(name, self.path / name, model_name)
        b.status = "training"
    ...
    def load(self, name:str) -> BertModel:
        ...
        b = BertModel(name, path, modeltype)
        b.tokenizer = AutoTokenizer.from_pretrained(modeltype)
        b.model =  AutoModelForSequenceClassification.from_pretrained(path / name)
        b.status = "loaded"
        # move loading into bertmodel ?
        return b
    
    def get(self, name:str)-> bool: #BertModel
        """
        Get a model : load or select it
        # TODO
        """
        return True
    ...
    def update(self):
        ...
        # TODO
        """
        # check all training model to see if the training finished
        return True
    

class BertModel():

    def __init__(self, name:str, path:Path, model_name:str, params:dict = {}) -> None:
        self.name:str = name
        self.path:Path = path
