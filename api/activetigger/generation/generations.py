...
class Generations:
    ...
    def __init__(self, db_manager: DatabaseManager, computing: list[UserComputing]) -> None:
    ...
    def get_generated(
        ...
        df = pd.DataFrame(result, columns=["time", "index", "prompt", "answer", "endpoint"])
