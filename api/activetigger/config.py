...
class Config(metaclass=_Singleton):
    ...
    def __init__(self):
        ...
        self.mode = os.environ.get("MODE") if os.environ.get("MODE") is not None and MODE.has_member_key(os.environ.get("MODE")) else "DEV"
        ...
        self.database_url = os.environ.get("DATABASE_URL", f"sqlite:///{os.path.join(self.data_path, 'projects', 'activetigger.db')}")
